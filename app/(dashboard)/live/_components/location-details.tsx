...
export default function LocationDetails({ session }: { session: any }) {
    ...
    const [hoverLocation, setHoverLocation] = useState<{ lat: number; lng: number } | null>(null);
    ...
    function getMarkerIcon(userType: string = ""): google.maps.Icon | undefined {
        if (typeof window !== "undefined" && window.google && window.google.maps) {
            let rawColor = userTypeColors[userType]
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="48" viewBox="0 0 32 48">
    ...
    return (
        <div className="relative bg-white h-full p-4">
            ...
            <div className="mb-24">
                <LoadScript googleMapsApiKey={"AIzaSyCLEfEp-SLiapNoQ9waRFFDFun4g-HawU8"}>
                    <GoogleMap
