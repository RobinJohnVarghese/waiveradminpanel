  ...
  return (
    <div className="min-h-screen flex flex-col bg-white p-4 pb-8 md:pb-16">
      ...
      <div className="border rounded-md lg:w-2/3">
        ...
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Fleet Name</p> : {details.vehicle_details ? details.vehicle_details.fleet_name: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Fleet ID</p> : {details.vehicle_details ? details.vehicle_details.fleet_id: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
        ...
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Vehicle Registration Number</p> :{" "}{details.vehicle_details ? details.vehicle_details.registration_number: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Vehicle Brand</p> :{" "}{details.vehicle_details ? details.vehicle_details.brand: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Vehicle Name</p> :{" "}{details.vehicle_details ? details.vehicle_details.name: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Vehicle Type</p> :{" "}{details.vehicle_details ? details.vehicle_details.vehicle_type: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
          <p>Vehicle Transmission Type</p> :{" "}{details.vehicle_details ? details.vehicle_details.transmission_type: "placeholder"}
        </div>
        <div className="border-b p-2 grid grid-cols-2 justify-between">
